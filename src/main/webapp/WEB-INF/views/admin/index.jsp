				...
				<div class="collapse navbar-collapse" id="navbarNav">
					<ul class="navbar-nav">
						<li class="nav-item"><a class="nav-link active"
							aria-current="page" href="admin/index.htm">Trang chủ</a></li>
						<li class="nav-item"><a class="nav-link"
							href="admin/phong.htm">Phòng</a></li>
						<li class="nav-item"><a class="nav-link"
							href="admin/caChieu.htm">Sắp Lịch</a></li>
						<li class="nav-item"><a class="nav-link"
							href="admin/thongKe.htm">Thống Kê</a></li>
					</ul>
				</div>
			</div>
		...
		<main class="table col listPhim_table" id="customers_table"
			...
			<section class="table__header">
				...
				<button class="btn btn-primary"
					style="width: 135px; height: 40px; border-radius: 20px"
					data-bs-toggle="modal" data-bs-target="#addPhimModel">Thêm
					bộ phim</button>
			</section>
						...
						<c:forEach var="p" items="${phims}">
							<tr>
								...
								<td><button class="btn btn-primary"
										...
										data-bs-toggle="modal" data-bs-target="#movie_${p.maPhim}">Xem/Sửa</button></td>
								<td><button type="submit"
										action="/admin/delete?${p.maPhim}"
										class="btn btn-danger deleteButton"
										style="width: 55px; height: 40px; border-radius: 20px"
										onclick="prepareDelete(${p.maPhim})">Xóa</button></td>
							</tr>
						</c:forEach>
					</tbody>
				</table>
		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<div class="modal-header custom-modal-header">
					...
					<button type="button" class="custom-close-btn btn_exit_addphim"
						data-bs-dismiss="modal" aria-label="Close">&times;</button>
				</div>
				<div class="modal-body">
					<form id="addPhimForm" method="POST" action="admin/addPhim.htm"
						enctype="application/x-www-form-urlencoded">
						<div class="row mb-3">
							<div class="col-md-6">
								<label for="tenPhim" class="form-label">Tên Phim:</label> <input
							...
							<div class="col-md-6">
								<label for="trailer" class="form-label">Trailer:</label> <input
									type="url" class="form-control" id="trailer" name="trailer"
									required>
							</div>
						</div>
						<div class="row mb-3">
						...
						<div class="row mb-3">
							...
							<div class="col-md-6">
								<label for="gioiHanTuoi" class="form-label">Giới Hạn
									Tuổi:</label> <input type="number" class="form-control"
									id="gioiHanTuoi" name="gioiHanTuoi" required>
							</div>
						</div>
						<div class="row mb-3">
							<div class="col-md-6">
								<label for="ngayHieuLucTu" class="form-label">Ngày Hiệu
									Lực Từ:</label> <input type="date" class="form-control"
									id="ngayHieuLucTu" name="ngayHieuLucTu" required>
							</div>
							<div class="col-md-6">
								<label for="ngayHieuLucDen" class="form-label">Ngày Hiệu
									Lực Đến:</label> <input type="date" class="form-control"
									id="ngayHieuLucDen" name="ngayHieuLucDen" required>
							</div>
						</div>
						<div class="mb-3">
							<label for="moTa" class="form-label">Mô Tả:</label>
						...
						<div class="mb-3">
							<label for="trangThai" class="form-label">Trạng Thái:</label> <select
								class="form-control" id="trangThai" name="trangThai" required>
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-secondary btn_canceladd_phim"
						data-bs-dismiss="modal">Hủy</button>
					<button type="submit" class="btn btn-primary btn_saveadd_phim"
						form="addPhimForm">Lưu</button>
				</div>
			</div>
		</div>
	</div>
