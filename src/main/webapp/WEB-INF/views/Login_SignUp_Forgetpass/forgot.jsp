        ...
        <div class="container">
            <div class="padding-top padding-bottom">
                <div class="account-area">
                    ...
                    <form:form class="account-form" action="${pageContext.request.contextPath}/check-forgot.htm" method="post" onsubmit="return validateForm()" modelAttribute="taikhoan">
                        <div class="form-group">
                            <label for="email">Email<span>*</span></label>
                            <form:input type="email" placeholder="Nhập email của bạn" id="email" path="email" class="form-control"/>
                            <div id="email-error" class="error-message">Email không được để trống và phải hợp lệ.</div>
                        </div>
