...
<body>
        ...
        <div class="main">
            ...
            <div class="row justify-content-center" id="movieContainer">
                <c:forEach var="cc" items="${caChieus}" varStatus="loop">
                    <div class="card m-4 movie-card" style="width: 16rem;" data-index="${loop.index}">
                ...
                <div class="col">
                    <nav aria-label="Page navigation example">
                        <ul class="pagination justify-content-center" id="pagination">
                            <li class="page-item  showPage1" active>
                                    <a class="page-link "  onclick="showPage(1)">1</a>
                            </li>
                            <li class="page-item showPage2" >
                                    <a class="page-link "  onclick="showPage(2)">2</a>
                            </li>
                            <li class="page-item  showPage3">
                                    <a class="page-link" onclick="showPage(3)">3</a>
                            </li>
                        </ul>
                    </nav>
                </div>
    ...
    <div class="modal fade" id="model_youtube_${p.phim.maPhim}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="youtubeModalLabel" aria-hidden="true">
    ...
    <!--Phần Model  -->
    <c:forEach var="p" items="${caChieus}">
    <div class="modal fade getmodals" id="movie_${p.phim.maPhim}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header custom-modal-header">
            ...
            <form class="form_film" method="POST" action="admin/updatePhim.htm" enctype="application/x-www-form-urlencoded">
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" name="maPhim" value="${p.phim.maPhim}" readonly>
                        </div>
                        <div class="col-md-6">
                            <label for="tenPhim" class="form-label">Tên Phim:</label>
                            <input type="text" class="form-control" id="tenPhim" name="tenPhim" value="${p.phim.tenPhim}" readonly>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <label for="thoiLuong" class="form-label">Thời Lượng(Phút):</label>
                            <input type="text" class="form-control" id="thoiLuong" name="thoiLuong" value="${p.phim.thoiLuong}" readonly>
                        </div>
                    </div>
                    <div class="mb-3">
                        <label for="moTa" class="form-label">Mô Tả:</label>
                        <textarea class="form-control" id="moTa" rows="3" name="moTa" readonly>${p.phim.moTa}</textarea>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <label for="luotXem" class="form-label">Lượt Xem:</label>
                            <input type="text" class="form-control" id="luotXem" name="luotXem" value="${p.phim.luotXem}" readonly>
                        </div>
                        <div class="col-md-6">
                            <label for="luotThich" class="form-label">Lượt Thích:</label>
                            <input type="text" class="form-control" id="luotThich" name="luotThich" value="${p.phim.luotThich}" readonly>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <select class="form-select" id="trangThai" name="trangThai" disabled style="width:370px; height:40px">
                                <option value="Đang Chiếu" ${p.phim.trangThai == 'Đang Chiếu' ? 'selected' : ''}>Đang Chiếu</option>
                                <option value="Sắp Chiếu" ${p.phim.trangThai == 'Sắp Chiếu' ? 'selected' : ''}>Sắp Chiếu</option>
                                <option value="Đã Chiếu" ${p.phim.trangThai == 'Đã Chiếu' ? 'selected' : ''}>Đã Chiếu</option>
                            </select>
                        </div>
                        <div class="col-md-6">
                            <label for="ngonNgu" class="form-label">Ngôn Ngữ:</label>
                            <input type="text" class="form-control" id="ngonNgu" name="ngonNgu" value="${p.phim.ngonNgu}" readonly>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <label for="phuDe" class="form-label">Phụ Đề:</label>
                            <input type="text" class="form-control" id="phuDe" name="phuDe" value="${p.phim.phuDe}" readonly>
                        </div>
                        <div class="col-md-6">
                            <label for="gioiHanTuoi" class="form-label">Giới Hạn Tuổi:</label>
                            <input type="text" class="form-control" id="gioiHanTuoi" name="gioiHanTuoi" value="${p.phim.gioiHanTuoi}" readonly>
                        </div>
                    </div>
